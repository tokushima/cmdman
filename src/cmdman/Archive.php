...
STAB
			...
			\cmdman\Std::println_danger($e::class.': '.$e->getMessage());
	 ...
	 * pharを展開する
	 */
	public static function unphar(string $phar_file, ?string $output=null): void{
